...
//            LogError($pcGPS->GetLastError() . ". Received data string: $ModuleDataString"); //Add message to the error log.
			...
			if (TRUE) {
				...
				isset($All_data_forwarding_variables_and_code_are_properly_modified_to_support_it)
				AND $All_data_forwarding_variables_and_code_are_properly_modified_to_support_it === TRUE
...
//Function to store incoming transmissions in an existing database as suggested above.
		private function StoreInDatabase(&$pcGPS, $ExtraModuleData) {
